...
function ContactSection() {
  return (
    <div id="contact" className="relative my-10 scroll-mt-24 text-white lg:my-14">
      <ToastContainer position="top-right" autoClose={3000} hideProgressBar theme="dark" />

      <div className="absolute -right-8 top-24 hidden flex-col items-center lg:flex">
        <span className="w-fit rounded-md bg-[#1a1443] p-2 px-5 text-xl text-white rotate-90">
          CONTACT
        </span>
